...
public:
    ...
    /// When true, force every file to use strict mode after all inherited
    /// configuration is applied. Rive also clears untyped config globals and
    /// keeps lints as warnings in readConfigRec().
