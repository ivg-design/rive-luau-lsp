---
name: rive-luau-lsp
description: Rive Luau type checker and language server for validating Rive scripting API usage. Triggers when writing, editing, debugging, or validating Rive Luau scripts. Targets Rive Web 2.42.1 and runtime-v0.1.384, with separately tiered Editor and source-backed surfaces.
---

# Rive Luau LSP

Use the canonical Rive Luau type checker for diagnostics. Its released callable target is Rive Web 2.42.1 / runtime-v0.1.384. Later canary signatures are not part of that target.
